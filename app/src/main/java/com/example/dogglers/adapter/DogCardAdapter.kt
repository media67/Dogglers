...
class DogCardAdapter(
    ...
    class DogCardViewHolder(view: View?): RecyclerView.ViewHolder(view!!) {
        ...
        val dogNameTextView: TextView? = view!!.findViewById(R.id.item_dog_name)
        val dogAgeTextView: TextView? = view!!.findViewById(R.id.item_dog_age)
        val dogHobbyTextView: TextView? = view!!.findViewById(R.id.item_dog_hobbies)
    }
